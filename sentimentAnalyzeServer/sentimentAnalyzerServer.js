...
app.get("/url/sentiment", (req,res) => {
  ...
  .then(analysisResults => {
    ...
    return res.send("url sentiment for "+req.query.url+JSON.stringify(analysisResults, null, 2));
  })
  .catch(err => {
    console.log('error:', err);
    })
...
app.get("/text/sentiment", (req,res) => {
  ...
  .then(analysisResults => {
    console.log(JSON.stringify(analysisResults, null, 2));
    return res.send("text sentiment for "+req.query.text+JSON.stringify(analysisResults, null, 2));
  })
  .catch(err => {
    console.log('error:', err);
  })
